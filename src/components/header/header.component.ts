...
@Component({
  ...
  template: `
<header class="bg-white/75 backdrop-blur-lg sticky top-0 z-30 shadow-sm border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      <div class="flex items-center space-x-4">
        ...
        <span class="text-xl font-semibold text-gray-900">Wayleave RMS</span>
      </div>
      <div class="flex items-center space-x-6">
        <div class="text-right">
          <p class="text-sm font-medium text-gray-800 truncate" [title]="userEmail()">{{ userEmail() }}</p>
        ...
        <button (click)="onLogout()" title="Sign Out" class="p-2 rounded-full text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
